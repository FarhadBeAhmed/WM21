...
public class TopSellingProModel implements Parcelable {
    ...
    protected TopSellingProModel(Parcel in) {
    ...
    public static final Creator<TopSellingProModel> CREATOR = new Creator<TopSellingProModel>() {
        @Override
        public TopSellingProModel createFromParcel(Parcel in) {
            return new TopSellingProModel(in);
        }

        @Override
        public TopSellingProModel[] newArray(int size) {
            return new TopSellingProModel[size];
        }
    };
