...
public class DigitalServicesAdapter extends RecyclerView.Adapter {
    ...
    public DigitalServicesAdapter(Context context, ArrayList<ItemMenuView> itemMenuViews, @LayoutRes int layout) {
        mList = itemMenuViews;
    ...
    public DigitalServicesAdapter addOnClickListener(ItemClickListener mListener) {
