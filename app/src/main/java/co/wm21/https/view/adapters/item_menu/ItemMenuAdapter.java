...
import co.wm21.https.view.activities.TransactionActivity;
import co.wm21.https.view.activities.EarningActivity;
import co.wm21.https.view.activities.GenealogyActivity;
import co.wm21.https.view.activities.RewardsActivity;
import co.wm21.https.view.activities.TrainingActivity;
import co.wm21.https.view.activities.mlm.ApplicationActivity;
...
public class ItemMenuAdapter extends RecyclerView.Adapter {
    ...
    public ItemMenuAdapter(Context context, ArrayList<ItemMenuView> itemMenuViews, @LayoutRes int layout,String type) {
        mList = itemMenuViews;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getClass()==ItemMenuHolder.class){
            ...
            if (type.equals("digitalBusiness"))
