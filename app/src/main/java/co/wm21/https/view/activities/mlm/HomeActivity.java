...
import co.wm21.https.view.adapters.item_menu.DigitalServicesAdapter;
import co.wm21.https.view.adapters.item_menu.ItemMenuAdapter;
import co.wm21.https.view.adapters.item_menu.ItemMenuView;
import co.wm21.https.view.adapters.item_menu.OffersAdapter;
...
public class HomeActivity extends AppCompatActivity implements OnProfileDetailsView, OnVerificationView, OnBalancesView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.socialsRecyclerView.setAdapter(new ItemMenuAdapter(this, socialsList, R.layout.layout_item_socials,"socialsList"));
        ...
        binding.digitalServiceRecyclerView.setAdapter(new DigitalServicesAdapter(this, digitalServiceList, R.layout.layout_item_digital_service_category).addOnClickListener((View, position) -> {
            if (position == 0) {
        ...
        binding.offersRecyclerView.setAdapter(new OffersAdapter(this, offerList, R.layout.item_offers_layout));


        digitalBusinessList = new ArrayList<>(
                Arrays.asList(
                        ...
                        new ItemMenuView("Reward", R.drawable.reward),
                         new ItemMenuView("Application", R.drawable.company)
        ...
        binding.digitalBusinessRecyclerView.setAdapter(new ItemMenuAdapter(this, digitalBusinessList, R.layout.layout_item_digital_business_category,"digitalBusiness"));


        communityWorkList = new ArrayList<>(
                Arrays.asList(
        ...
        binding.communityWorkRecyclerView.setAdapter(new ItemMenuAdapter(this, communityWorkList, R.layout.layout_item_community_work,"communityWork"));
