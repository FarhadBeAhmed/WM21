package co.wm21.https.view.fragments.member.verifications;
...
public class VerifyAccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (taskNum != 0) {
            switch (taskNum) {
                case 1:
                    switchFragment(new SignUploadFragment(), "SignUploadFragment");
                    break;
                case 2:
                    switchFragment(new PhotoUploadFragment(), "PhotoUploadFragment");

                    break;

                case 3:
                    switchFragment(new GatewayVerifyFragment(), "GatewayVerifyFragment");

                    break;

                case 4:
                    switchFragment(new ContactUpdateFragment(), "ContactUpdateFragment");

                    break;

                case 5:
                    switchFragment(new ProfileUpdateFragment(), "ProfileUpdateFragment");
                    break;

                case 6:
                    switchFragment(new UpdatePasswordFragment(), "UpdatePasswordFragment");

                    break;

                case 7:
                    switchFragment(new MobileVerifyFragment(), "MobileVerifyFragment");
                    break;
