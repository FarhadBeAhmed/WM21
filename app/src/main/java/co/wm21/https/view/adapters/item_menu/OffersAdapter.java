...
public class OffersAdapter extends RecyclerView.Adapter {
    ...
    public OffersAdapter(Context context, ArrayList<ItemMenuView> itemMenuViews, @LayoutRes int layout) {
        mList = itemMenuViews;
    ...
    public OffersAdapter addOnClickListener(ItemClickListener mListener) {
