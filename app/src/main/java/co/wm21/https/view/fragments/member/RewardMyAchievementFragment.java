...
import co.wm21.https.view.adapters.RewardMyAchievementAdapter;
import co.wm21.https.databinding.FragmentRewardMyAchievementBinding;
 ...
 */
public class RewardMyAchievementFragment extends Fragment implements OnRewardPolicyView {
   ...
   // RecyclerView recyclerViewRewardPolicy;
    FragmentRewardMyAchievementBinding binding;
     List<RewardPolicyDataListModel> rewardsModel = new ArrayList<>();
    private RewardMyAchievementAdapter rAdapter;
  LoadingDialog loadingDialog;
    public RewardMyAchievementFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // ButterKnife.bind(this, mView);
        binding=FragmentRewardMyAchievementBinding.inflate(getLayoutInflater());
    ...
    private void initializedFields() {
        ...
        rAdapter = new RewardMyAchievementAdapter(rewardsModel, getActivity());
