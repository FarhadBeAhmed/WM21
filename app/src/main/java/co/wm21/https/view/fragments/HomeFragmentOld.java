...
public class HomeFragmentOld extends Fragment implements OnHomeTopSliderImageView, OnHomeCategoryView, OnHomePopularProductView, OnHotProductView, OnHomePopularCatProductView, OnBlogListView, OnTopSellingProView {
...
/*bundle.putString(ConstantValues.ARGUMENT1, categoryList.get(3).getCatID());
    ...
    private void categories() {
        ...
        categoryAdapter = new CategoryAdapter(getContext(), categoryList, Constant.GRID_LAYOUT).addOnClickListener((View, position) -> {
            ...
            Bundle bundle = new Bundle();
            bundle.putString(ConstantValues.ARGUMENT1, cat_id);
