package co.wm21.https.view.activities.affiliate;
...
public class HomeActivityAff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityHomeAffiliateBinding.inflate(getLayoutInflater());
...
//                profileFab.setText(response.getString(Constant.Profile.Affiliate.NAME));
        ...
        MySingleton.getInstance(this).addToRequestQueue(api.profile(user.getUsername(), user.getPassword(), response -> {
            try {
...
//            switchFragment(new ProfileFragment(), "ProfileFragment");
        ...
        binding.offersRecyclerView.setAdapter(new ItemMenuAdapter(this, offerList, R.layout.item_offers_layout,"digitalService"));
        ...
        binding.digitalServiceRecyclerView.setAdapter(new ItemMenuAdapter(this, digitalServiceList, R.layout.layout_item_digital_service_category,"digitalService").addOnClickListener((View, position) -> {
